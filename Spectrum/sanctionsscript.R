...
gendt1 <- Match(Y = dft1$polity2, Tr = dft1$sanctions, X = X, Weight.matrix = dt1)
#save(gendt1, file = "gendt1.Rdata")
...
gendt2 <- Match(Y = dft2$polity2, Tr = dft2$sanctions, X = X, Weight.matrix = dt2)
#save(gendt2, file = "gendt2.Rdata")
...
gendt3 <- Match(Y = dft3$polity2, Tr = dft3$sanctions, X = X, Weight.matrix = dt3)
#save(gendt3, file = "gendt3.Rdata")
...
gendt4 <- Match(Y = dft4$polity2, Tr = dft4$sanctions, X = X, Weight.matrix = dt4)
#save(gendt4, file = "gendt4.Rdata")
...
gendt5 <- Match(Y = dft5$polity2, Tr = dft5$sanctions, X = X, Weight.matrix = dt5)
#save(gendt5, file = "gendt5.Rdata")
...
gennpt1 <- Match(Y = dfnp1$polity2, Tr = dfnp1$sanctions, X = X, Weight.matrix = dnp1)
save(gennpt1, file = "gennpt1.Rdata")
...
gennpt2 <- Match(Y = dfnp2$polity2, Tr = dfnp2$sanctions, X = X, Weight.matrix = dnp2)
save(gennpt2, file = "gennpt2.Rdata")
...
gennpt3 <- Match(Y = dfnp3$polity2, Tr = dfnp3$sanctions, X = X, Weight.matrix = dnp3)
save(gennpt3, file = "gennpt3.Rdata")
...
gennpt4 <- Match(Y = dfnp4$polity2, Tr = dfnp4$sanctions, X = X, Weight.matrix = dnp4)
save(gennpt4, file = "gennpt4.Rdata")
...
gennpt5 <- Match(Y = dfnp5$polity2, Tr = dfnp5$sanctions, X = X, Weight.matrix = dnp5)
save(gennpt5, file = "gennpt5.Rdata")
...
table1 <- rbind(full, tr1, tr2, tr3, tr4, tr5, npr1, npr2, npr3, npr4, npr5)

save(table1, file = "Table1.Rdata")
stargazer(table1, summary = F, rownames = FALSE)
